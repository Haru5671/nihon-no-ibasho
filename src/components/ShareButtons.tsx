...
const BUTTONS = [
  {
    ...
    base: "text-on-surface-variant border-outline-variant hover:text-white hover:bg-on-surface hover:border-on-surface",
  },
  {
    id: "threads",
    label: "Threads",
    ...
    <div className="flex items-center gap-1">
      {BUTTONS.map((btn) => (
        <button
          ...
          className={`flex items-center gap-1 px-2.5 py-1.5 text-xs font-semibold border rounded-md transition-all duration-150 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 ${btn.base}`}
        >
          {btn.icon}
